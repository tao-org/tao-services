...
public class WMSComponentBean {
    ...
    public WMSComponentBean() {
        this.type = ContainerType.WMS;
    }

    public WMSComponentBean(WMSComponent src) {
        this.id = src.getId();
    ...
    public WMSComponent toComponent() {
        final WMSComponent entity = new WMSComponent();
