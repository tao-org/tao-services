...
public class SampleDSGroupSnapWorkflow extends SampleWorkflowBase {
    ...
    protected void addNodes(WorkflowDescriptor workflow) throws PersistenceException {
        ...
        values.put("startDate", "2018-07-15");
        values.put("endDate", "2018-07-17");
        values.put("tileId", "34TFR");
        values.put("footprint", "POLYGON((23.08888415063469 45.64122237960987,23.497142114745625 45.64122237960987,23.497142114745625 45.884014164289056,23.08888415063469 45.884014164289056,23.08888415063469 45.64122237960987))");
        ...
        query2.setLimit(1);
        values = new HashMap<>();
        values.put("startDate", "2017-07-30");
        values.put("endDate", "2017-08-01");
        values.put("tileId", "34TFR");
        values.put("footprint", "POLYGON((23.08888415063469 45.64122237960987,23.497142114745625 45.64122237960987,23.497142114745625 45.884014164289056,23.08888415063469 45.884014164289056,23.08888415063469 45.64122237960987))");
